import{d as q,c as r,h as o,o as n,l as s,i as C,n as u,k as B,t as D}from"./iframe-Dqbl3-QT.js";/* empty css              */import"./preload-helper-Dp1pzeXC.js";const T=["for"],w={key:0,class:"dk:text-rose-500"},N=["value","disabled","placeholder","required","name","id","readonly","aria-label","aria-disabled","aria-required"],j=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
...
}`,...(f=(c=t.parameters)==null?void 0:c.docs)==null?void 0:f.source}}};const A=["Default"];export{t as Default,A as __namedExportsOrder,L as default};
