import{d as h,b as r,e as d,g as s,j as S,n as u,k as _,t as q,o as n}from"./vue.esm-bundler-DsTq9UXQ.js";/* empty css              */const w=["for"],C={key:0,class:"dk:text-rose-500"},I=["type","value","disabled","placeholder","required","name","id","pattern","aria-label","aria-disabled","aria-required"],D=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
