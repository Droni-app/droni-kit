import{d as q,b as r,e as o,o as n,g as s,j as C,n as u,k as B,t as D}from"./vue.esm-bundler-rD1pBn_I.js";/* empty css              */const j=["for"],T={key:0,class:"dk:text-rose-500"},w=["value","disabled","placeholder","required","name","id","aria-label","aria-disabled","aria-required"],N=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
