import{e as p,o as l,k as h,w as g,l as f,f as x,m as y,n as z,h as a}from"./iframe-DjC63Ylc.js";import{g as w,a as _}from"./router-detection-CynBHpJD.js";const C={key:1},q=`
  dk:transition
  dk:text-center
  ...
  dk:active:scale-95
  dk:max-w-full`,t=p({__name:"DuiButton",props:{variant:{default:"solid"},color:{default:"neutral"},size:{default:"md"},type:{default:"button"},disabled:{type:Boolean,default:!1},loading:{type:Boolean,default:!1},block:{type:Boolean,default:!1},title:{default:void 0},rounded:{default:"all"},to:{default:void 0}},setup(s){const e=s,r=a(()=>w(e.to)),b=a(()=>{const d={};return r.value==="button"&&(d.type=e.type),_(e.to,r.value,d)}),i={sm:"dk:text-sm dk:px-3 dk:py-1.5",md:"dk:text-base dk:px-4 dk:py-2",lg:"dk:text-lg dk:px-5 dk:py-3"},m={all:"dk:rounded",top:"dk:rounded-t",bottom:"dk:rounded-b",left:"dk:rounded-l",right:"dk:rounded-r",none:"dk:rounded-none"},o={solid:{base:"dk:border-b",neutral:`
      dk:border-zinc-500
