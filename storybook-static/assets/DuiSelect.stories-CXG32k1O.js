import{d as _,c,h as t,l as u,i as C,n as m,k as q,t as r,F as N,j as L,o as n}from"./iframe-Dqbl3-QT.js";/* empty css              */import"./preload-helper-Dp1pzeXC.js";const B=["for"],D={key:0,class:"dk:text-rose-500"},j=["id","name","disabled","required","readonly","aria-label","aria-disabled","aria-required"],w={key:0,disabled:"",selected:"",hidden:""},F=["value","selected"],O=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
...
}`,...(b=(f=s.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};const T=["Default"];export{s as Default,T as __namedExportsOrder,P as default};
