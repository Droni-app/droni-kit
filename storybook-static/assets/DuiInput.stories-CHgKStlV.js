import{r as e}from"./iframe-DjC63Ylc.js";import{_ as a}from"./DuiInput-Cx9tTbRc.js";/* empty css              */import"./preload-helper-Dp1pzeXC.js";const A={title:"Forms/Input",component:a,tags:["autodocs"],argTypes:{modelValue:{control:{type:"text"},description:"The input value (v-model)"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Size of the input"},block:{control:{type:"boolean"},description:"Whether the input takes full width"},rounded:{control:{type:"select"},options:["all","top","bottom","left","right","none"],description:"Border radius style"}},parameters:{docs:{description:{component:"A styled input component that accepts all native HTML input attributes via $attrs. Only includes custom props for styling (size, block, rounded) and v-model support."}}}},r={args:{size:"md",block:!0,rounded:"all"},render:d=>({components:{DuiInput:a},setup(){const t=e("");return{args:d,inputValue:t}},template:`
      <div class="dk:p-4">
