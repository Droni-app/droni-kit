import{d as h,b as r,e as d,g as s,j as S,n as u,k as _,t as q,o as n}from"./vue.esm-bundler-DkrdOEY0.js";/* empty css              */const w=["for"],C={key:0,class:"dk:text-rose-500"},I=["type","value","disabled","placeholder","required","name","id","pattern","readonly","aria-label","aria-disabled","aria-required"],B=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
...
}`,...(p=(c=l.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};const Z=["Default"];export{l as Default,Z as __namedExportsOrder,A as default};
