import{_ as e}from"./DuiTextarea-D6Qu-6kx.js";/* empty css              */import"./iframe-BX9sGRHr.js";import"./preload-helper-Dp1pzeXC.js";const S={title:"Forms/Textarea",component:e,tags:["autodocs"],argTypes:{modelValue:{control:{type:"text"}},size:{control:{type:"select"},options:["sm","md","lg"]},block:{control:{type:"boolean"}},rounded:{control:{type:"select"},options:["all","top","bottom","left","right","none"]},autoheight:{control:{type:"boolean"}},resize:{control:{type:"select"},options:["none","both","horizontal","vertical"]}}},a={args:{size:"md",block:!0,rounded:"all",modelValue:"",autoheight:!0,resize:"vertical"},render:f=>({components:{DuiTextarea:e},setup(){return{args:f}},template:`
