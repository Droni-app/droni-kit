import{d as _,b as i,e as t,g as s,j as C,n as r,k as q,t as u,F as L,l as j,o as n}from"./vue.esm-bundler-DkrdOEY0.js";/* empty css              */const D=["for"],B={key:0,class:"dk:text-rose-500"},w=["id","name","disabled","required","aria-label","aria-disabled","aria-required"],F={key:0,disabled:"",selected:"",hidden:""},N=["value","selected"],O=`
  dk:border-b
  dk:border-zinc-300
  dk:bg-zinc-50
  dk:text-zinc-800
