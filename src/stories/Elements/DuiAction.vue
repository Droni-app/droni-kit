...
const baseClass = 'transition text-center rounded disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer hover:shadow-md overflow-hidden text-ellipsis whitespace-nowrap active:scale-95'
...
const computedClasses = computed(() => {
  ...
  const blockStyle = props.block ? 'block' : 'inline-block'
